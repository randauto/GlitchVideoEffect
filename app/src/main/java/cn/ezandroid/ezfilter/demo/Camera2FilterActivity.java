...
import asha.marcus.glitchvideomakerglitchphotoeffects.filter_render.Glitch2Filter;
...
public class Camera2FilterActivity extends BaseActivity {
    ...
    public static SurfaceFitView mRenderView;
    ...
    private FilterRender mTestRender;
        ...
        $(R.id.change_filter).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mCurrentRender == mBWRender) {
                    mCurrentRender = mTestRender;
                    mRenderPipeline.removeFilterRender(mBWRender);
                    mRenderPipeline.addFilterRender(mTestRender);
                } else {
                    mCurrentRender = mBWRender;
                    mRenderPipeline.removeFilterRender(mTestRender);
